 ...
 *
 * ⚠️ PLACEHOLDER: os textos abaixo são posicionamento genérico da dupla.
...
export const about: AboutContent = {
  ...
  paragraphs: [
    'A VÉRTICE nasceu para resolver um problema simples: a maioria dos sites parece igual e não vende. Somos uma dupla de front-end que trata cada projeto como a nossa própria vitrine — do primeiro pixel à entrega final.',
    'Trabalhamos lado a lado, sem intermediários e sem burocracia de agência. Isso significa comunicação direta, decisões rápidas e um cuidado artesanal com cada detalhe da sua presença digital — não importa o seu segmento.',
  ],
  pillars: [
    {
      id: 'pillar-craft',
    ...
    },
    {
      ...
      description:
        'Você fala diretamente com a dupla que desenha e desenvolve. Sem ruído, sem repasse — mais agilidade e clareza.',
    },
    {
